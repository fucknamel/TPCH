...
%>
    <div class="jumbotron">
        <div class="input-group input-group-lg">
            <span class="input-group-addon">表：国家</span>
            <input id="search" type="text" class="form-control" placeholder="搜索国家..." value="<%=search%>" onkeypress="isenter(event)">
            <span class="input-group-btn">
            <button class="btn btn-default" type="submit" onclick="window.location.href='/views/jsp/nation_list.jsp?search='+document.getElementById('search').value">确定</button>
            </span>
        </div>
        <%
